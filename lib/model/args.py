...
def get_args():
    ...
    parser.add_argument('--model', type=str, default='static',
                        choices=['logistic_regression', 'random_forest', 'kim_cnn', 'hybrid_cnn', 'gru_cnn'])
    ...
    parser.add_argument('--dataset', type=str, default='python_clones', choices=['python_clones', 'all_clones'])
    ...
    parser.add_argument('--code-embedding', type=str, default='baseline', choices=['baseline', 'docstring'])
